...
Поддержка HS5 дополняет обычную логику BlueAudioSwitch. Программа сама следит за физическими Bluetooth-подключениями, периодически запрашивает переподключение ранее сопряжённых аудиоустройств и отдаёт приоритет тому устройству, которое подключилось последним. Для Bluetooth она выбирает обычный профиль Stereo/A2DP, а не Hands-Free с ухудшенным качеством звука.
...
- Самостоятельно запрашивает переподключение сопряжённых Bluetooth-аудиоустройств.
- Отслеживает момент физического подключения и переключается на последнее подключившееся устройство.
- Переключает все три роли аудио Windows, когда профиль устройства действительно становится активным.
- Предпочитает Stereo/A2DP профилю Hands-Free.
- Возвращает предыдущий обычный аудиовыход после отключения последнего Bluetooth-устройства.
